...
Future<void> reGenerateToken() async {
  ...
  // final userPASSWORD = getStringAsync(SharedPreferenceConst.USER_PASSWORD);
  // Map<String, dynamic> req;
  // if (loginUserData.value.loginType == LoginTypeConst.LOGIN_TYPE_OTP) {
  //   req = {
  //     UserKeys.username: loginUserData.value.mobile,
  ...
  // DashboardController dashboardController = gets.Get.find<DashboardController>();
